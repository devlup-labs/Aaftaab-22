...
const TabContent = tw(motion.div)`mt-6 flex overflow-hidden sm:-mr-10 md:-mr-6 lg:-mr-12`;
const CardContainer = tw.div`mt-10 w-full w-1/4 m-5 mx-5 sm:w-1/2 md:w-1/3 lg:w-1/4 sm:pr-10 md:pr-6 lg:pr-12  `;
